...
public class ProtectedInitJar {
    ...
    public ProtectedInitJar(Context context) {
    ...
    public boolean check(String jar) {
        Boolean cached = jars.get(jar);
        if (cached != null) return cached;
        boolean result = scan(jar, context.getPackageName());
        jars.put(jar, result);
        return result;
    }
